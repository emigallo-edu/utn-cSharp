...
namespace Clase3.Services
{
    public class TableService
    {
        ...
        /// <returns></returns>
        public List<Table> GetTablesInStockByColorAndMaterial(string color, Materials material)
        {
            List<Table> rett = new List<Table>();
        ...
        /// Devolver en orden descendente según cantidad
        /// </summary>
        /// <param name="material"></param>
        /// <returns></returns>
        ...
        {
            List<string> rett = new List<string>();
            var list = this.GetTablesInStock();


            rett = list.Select(item => item.Color).Distinct().ToList();
